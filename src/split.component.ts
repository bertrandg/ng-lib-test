import { Component, ChangeDetectionStrategy, ChangeDetectorRef, Input, OnChanges, OnDestroy, Output, EventEmitter, HostBinding, ElementRef, Renderer, SimpleChanges } from '@angular/core';
...
export class SplitComponent implements OnChanges, OnDestroy {
    ...
    private get nbGutters(): number {
        return (this.visibleAreas.length > 0) ? this.visibleAreas.length - 1 : 0;
    }
